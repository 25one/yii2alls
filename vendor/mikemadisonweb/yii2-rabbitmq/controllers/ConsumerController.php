...
namespace vendor\mikemadisonweb\rabbitmq\controllers;

use vendor\mikemadisonweb\rabbitmq\components\BaseRabbitMQ;
use vendor\mikemadisonweb\rabbitmq\components\Consumer;
